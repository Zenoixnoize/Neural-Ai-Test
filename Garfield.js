...
if(text == "කොහොමද"){
    ...
    case 'fb2': case 'facebook2': {
                ...
                GarfieldNeural.sendMessage(m.chat, { video: { url: anu.result.url[0].url }, jpegThumbnail:global.thumb, caption: }, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
            }
            break
                default:
                if (budy.startsWith('=>')) {
